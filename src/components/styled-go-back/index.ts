...
const StyledLink = tw(
  Link,
)`transition transform duration-500 ease-in-out w-10 h-10 flex items-center justify-center rounded-full outline-none bg-gray-100 hover:(bg-teal-900 scale-125) focus:(border-2 border-yellow-500)`;
